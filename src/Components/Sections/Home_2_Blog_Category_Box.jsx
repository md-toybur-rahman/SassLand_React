...
const Home_2_Blog_Category_Box = () => {
    return (
        <section className="bg-[#FDFCFA] border border-[#ECE8DF] rounded-xl px-[29px] py-[46px]">
            <div className="lg:w-[330px] max-w-[330px]">
                <div className="max-w-[320px] h-10 border border-[#CED2DA] rounded-lg flex items-center gap-1 px-3 py-2">
                ...
                <div className="mt-5">
                    ...
                    <div className="mt-[22px] max-w-[300px]">
                        <div>
                            <Link to="/Home_2/Blog" className="text-[#676769] text-sm">Marketing Strategies & Innovations (05)</Link>
                ...
                <div className="mt-[44px]">
                    ...
                    <div className="mt-[22px] max-w-[319px]">
                        ...
                        <Link to="Home_2/Blog" className="mt-2">
                            <p className="text-[#676769] text-base">Don’t Count on Freeto Win You Customers</p>
                            <p className="text-[#B1B1B1] text-sm">July 02, 2021</p>
                            <hr className="mt-2 border-t border-[#ECE8DF]" />
                        </Link>
...
export default Home_2_Blog_Category_Box;